...
# Imprimir el total de vectores pintados y el promedio del tamaño de los vectores
print("Total de vectores pintados:", total_vectors)
print("Promedio del tamaño de los vectores:", average_magnitude)
