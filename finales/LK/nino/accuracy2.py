...
accuracy_matrix_file = "metricas/nino/LK/accuracy_matrix.txt"
...
with open('metricas/nino/LK/metricas.txt', 'w') as file:
...
archivo_salida = "metricas/nino/LK/metricas.csv"
