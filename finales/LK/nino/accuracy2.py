...
confusion_matrices_folder = "matrices_confusion/nino/LK"
accuracy_matrix_file = "metricas/nino/LK/accuracy_matrixLK.txt"
...
with open('metricas/nino/LK/metricasLK.txt', 'w') as file:
...
archivo_salida = "metricas/nino/LK/metricasLK.csv"
