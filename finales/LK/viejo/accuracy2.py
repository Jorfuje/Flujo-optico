...
confusion_matrices_folder = "matrices_confusion/viejo/LK"
accuracy_matrix_file = "metricas/viejo/LK/accuracy_matrixLK.txt"
...
with open('metricas/viejo/LK/metricasLK.txt', 'w') as file:
...
archivo_salida = "metricas/viejo/LK/metricasLK.csv"
