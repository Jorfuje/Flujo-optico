...
accuracy_matrix_file = "metricas/viejo/LK/accuracy_matrix.txt"
...
with open('metricas/viejo/LK/metricas.txt', 'w') as file:
...
archivo_salida = "metricas/viejo/LK/metricas.csv"
