...
video_path = "finales/LK/viejo/viejo.mp4"
output_video_path = "videos/LKviejo.mp4"
promedios_file = "promedios/viejo/LK.txt"
output_folder = "imagenes_salida/viejo/LK"
...
with open(promedios_file, 'r') as file:
    for line in file:
        if line.startswith("Promedio final de celda"):
            ...
            promedios.append(promedio + 12.5)
