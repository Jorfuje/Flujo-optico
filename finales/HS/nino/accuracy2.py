...
confusion_matrices_folder = "matrices_confusion/nino/HS"
accuracy_matrix_file = "metricas/nino/HS/accuracy_matrixHS.txt"
...
with open('metricas/nino/HS/metricasHS.txt', 'w') as file:
...
archivo_salida = "metricas/nino/HS/metricasHS.csv"
