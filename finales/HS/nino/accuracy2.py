...
accuracy_matrix_file = "metricas/nino/HS/accuracy_matrix.txt"
...
with open('metricas/nino/HS/metricas.txt', 'w') as file:
...
archivo_salida = "metricas/nino/HS/metricas.csv"
