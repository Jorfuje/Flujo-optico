...
accuracy_matrix_file = "metricas/viejo/HS/accuracy_matrix.txt"
...
with open('metricas/viejo/HS/metricas.txt', 'w') as file:
...
archivo_salida = "metricas/viejo/HS/metricas.csv"
