...
confusion_matrices_folder = "matrices_confusion/viejo/HS"
accuracy_matrix_file = "metricas/viejo/HS/accuracy_matrixHS.txt"
...
with open('metricas/viejo/HS/metricasHS.txt', 'w') as file:
    file.write("accuracyHS = " + str(accuracy_values) + "\n")
    file.write("precisionHS = " + str(precision_values) + "\n")
    file.write("recallHS = " + str(recall_values) + "\n")
    file.write("measureHS = " + str(measure_values) + "\n")
...
archivo_salida = "metricas/viejo/HS/metricasHS.csv"
