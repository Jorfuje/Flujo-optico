...
output_folder = "imagenes_salida/viejo/HS"
...
def obtener_indices_region_interes():
    ...
    inicio = (4, 0)  # Filas de 0 a 16, Columnas de 4 a 18
    fin = (17, 20)
...
if __name__ == "__main__":
    video_path = "finales/HS/viejo/viejo.mp4"
    ...
    output_video_path = "videos/HSviejo.mp4"
    ...
    while ret:  # Mientras haya frames disponibles
        ...
        for y in range(0, frame.shape[0], cell_height):
            for x in range(0, frame.shape[1], cell_width):
                ...
                if 4 <= cell_x < 17 and 0 <= cell_y < 20:
                    ...
                    # cv2.arrowedLine(frame, (x, y), (x + 15, y + 15), color, 1, tipLength=0.25)
