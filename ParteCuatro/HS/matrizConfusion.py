...
def load_matrix_from_file(file_path):
    """
    Carga una matriz desde un archivo de texto y la devuelve como un array NumPy.

    Parámetros:
        file_path (str): Ruta al archivo de texto que contiene la matriz.

    Retorno:
        np.array: La matriz cargada como un array NumPy.
    """
...
def calculate_confusion_matrix(true_matrix, predicted_matrix):
    """
    Calcula la matriz de confusión a partir de las matrices verdadera y predicha.

    Parámetros:
        true_matrix (np.array): La matriz verdadera.
        predicted_matrix (np.array): La matriz predicha.

    Retorno:
        np.array: La matriz de confusión.
    """
...
true_matrices_folder = "imagenes_iteracionHS"
...
confusion_matrices_folder = "confusion_matricesHSElevador"
