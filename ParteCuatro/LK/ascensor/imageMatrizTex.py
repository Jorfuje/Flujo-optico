...
output_folder = "matrices_iteracion"

# Crear la carpeta para almacenar los archivos de matriz por iteración si no existe
...
while True:
    ...
    # Guardar la matriz del video en un archivo de texto por iteración
